...
public class ApplicationController extends Application {
    ...
    public boolean validarNuevoUsuario(String password, String confirmPassword)
    {
    ...
    public void crearUsuario(String nombre, String apellido, Integer edad, String usuario, String password)
    {
        users.add(new User(nombre, apellido, usuario, password, edad));
    }
}
